...
def cleanup_old_transcriptions():
    while True:
        try:
            ...
            result=transcriptions_collection.delete_many({"created_at":{"$lt":seven_days_ago}})
            logging.info(f"Cleanup finished: Deleted {result.deleted_count} old transcriptions.")
        except Exception as e:
