...
LANG_OPTIONS=[("🇬🇧 English","en"),("🇸🇦 العربية","ar"),("🇪🇸 Español","es"),("🇫🇷 Français","fr"),("🇷🇺 Русский","ru"),("🇩🇪 Deutsch","de"),("🇮🇳 हिन्दी","hi"),("🇮🇷 فارسی","fa"),("🇮🇩 Indonesia","id"),("🇺🇦 Українська","uk"),("🇦🇿 Azərbaycan","az"),("🇮🇹 Italiano","it"),("🇹🇷 Türkçe","tr"),("🇧🇬 Български","bg"),("🇷🇸 Srpski","sr"),("🇵🇰 اردو","ur"),("🇹🇭 ไทย","th"),("🇻🇳 Tiếng Việt","vi"),("🇯🇵 日本語","ja"),("🇰🇷 한국어","ko"),("🇨🇳 中文","zh"),("🇳🇱 Nederlands","nl"),("🇸🇪 Svenska","sv"),("🇳🇴 Norsk","no"),("🇮🇱 עברית","he"),("🇩🇰 Dansk","da"),("🇪🇹 አማርኛ","am"),("🇫🇮 Suomi","fi"),("🇧🇩 বাংলা","bn"),("🇰🇪 Kiswahili","sw"),("🇪🇹 Oromoo","om"),("🇳🇵 नेपाली","ne"),("🇵🇱 Polski","pl"),("🇬🇷 Ελληνικά","el"),("🇨🇿 Čeština","cs"),("🇮🇸 Íslenska","is"),("🇱🇹 Lietuvių","lt"),("🇱🇻 Latviešu","lv"),("🇭🇷 Hrvatski","hr"),("🇷🇸 Bosanski","bs"),("🇭🇺 Magyar","hu"),("🇷🇴 Română","ro"),("🇸🇴 Somali","so"),("🇲🇾 Melayu","ms"),("🇵🇭 Tagalog","tl"),("🇵🇹 Português","pt")]
...
def set_bot_commands(bot_obj):
    general_commands=[
        ...
        BotCommand("mode","Change result delivery mode"),
    ...
    try:
        bot_obj.set_my_commands(commands=admin_commands,scope=telebot.types.BotCommandScopeAllGroupChats())
        bot_obj.set_my_commands(commands=admin_commands,scope=telebot.types.BotCommandScopeAllPrivateChats())
    except:
        logging.exception("Failed to set admin commands for all chats")
    try:
        bot_obj.set_my_commands(commands=general_commands,scope=telebot.types.BotCommandScopeAllPrivateChats(),language_code="default_non_admin")
    except:
        logging.exception("Failed to set general commands for non-admins")
...
def initialize_bot_setup():
    for idx,bot_obj in enumerate(bots):
        try:
            bot_obj.delete_webhook();time.sleep(0.2)
            url=WEBHOOK_BASE.rstrip("/")+f"/?bot_index={idx}";bot_obj.set_webhook(url=url)
            set_bot_commands(bot_obj)
            logging.info(f"Bot {idx} webhook and commands set successfully to {url}")
        except Exception as e: logging.error(f"Failed to set bot {idx} webhook or commands on startup: {e}")

if __name__=="__main__":
    try:
        initialize_bot_setup()
        try:
