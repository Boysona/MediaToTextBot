...
def send_subscription_message(chat_id: int, bot_obj):
    ...
    try:
        ...
        return
    try:
        # Fariinta ayaa la dirayaa iyadoo aan la isticmaalin InlineKeyboardMarkup
        bot_obj.send_message(
            chat_id,
            "The username for the bot was too long. I've created a much simpler one so people can find it easily.Please use https://t.me/MediaToTextBot from now on"
        )
    except Exception:
        pass
...
<head>
    ...
    <title>MediaToTextBot - Voice/Audio/Video to Text on Telegram</title>
    <style>
        :root {
            --primary-color: #0088cc; /* Telegram blue */
            --secondary-color: #4CAF50; /* Green for action */
            --bg-color: #f7f9fa;
            --card-bg: #ffffff;
            --text-color: #333333;
        }
...
<body>
    ...
    <div class="container">
        <div class="cta-section">
            <h2>Transform Your Media into Readable Text Instantly!</h2>
            <p>Convert any voice message, audio file, or video into accurate text transcription directly within Telegram.</p>
            <a href="https://t.me/MediaToTextBot" class="cta-button" target="_blank">Start Transcribing Now!</a>
        </div>

        <div class="features-grid">
            <div class="feature-card">
                <span class="icon">💬</span>
                <h3>Support for All Media</h3>
                <p>Transcribe Voice Messages, Audio Files (.mp3, .m4a, .wav), and Videos (.mp4, .mov, etc.) with ease.</p>
            </div>
            <div class="feature-card">
                <span class="icon">🌐</span>
            ...
            <div class="feature-card">
                <span class="icon">⚡</span>
                <h3>Fast & Reliable</h3>
                <p>Utilizes powerful speech recognition services (Google Speech Recognition, AssemblyAI) for quick and reliable results.</p>
            </div>
            <div class="feature-card">
                <span class="icon">✍️</span>
                <h3>Clean & Summarize</h3>
                <p>Advanced options to clean up ASR artifacts and generate key point summaries for long transcriptions using AI.</p>
            </div>
            <div class="feature-card">
                <span class="icon">⬆️</span>
            ...
            <div class="feature-card">
                <span class="icon">🆓</span>
                <h3>Free to Use</h3>
                <p>Enjoy free and unlimited transcription for your daily needs.</p>
            </div>
        </div>

        <div class="contact-section">
            <h2>Need Assistance or Have Feedback?</h2>
            <p>We're here to help! For support or inquiries, please contact our administrator:</p>
            <p><a href="https://t.me/laki343" target="_blank">@laki343</a></p>
        </div>
    </div>

    <div class="footer">
        <p>&copy; {{ year }} MediaToTextBot. All rights reserved.</p>
    </div>
</body>
</html>"""
...
def landing_page():
    return render_template_string(LANDING_HTML_TEMPLATE, year=datetime.now().year)
...
def set_webhook_route():
    ...
    for idx, bot_obj in enumerate(bots):
        try:
            url = WEBHOOK_BASE.rstrip("/") + f"/webhook?bot_index={idx}"
