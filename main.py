...
def transcribe_via_selected_service(input_path:str, lang_code:str):
    # Waxaan halkan ku daynayay qiime been abuur ah (dummy value) si aan u tijaabiyo haddii la dejiyay
    # Hadda waxaan u baahannahay inaan hubinno in ASSEMBLYAI_API_KEY uu leeyahay qiime run ah (truthy value)
